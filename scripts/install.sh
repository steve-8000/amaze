...
# AMAZE Coding Agent Installer
# Usage: curl -fsSL https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.sh | sh
#
# Options:
...
install_via_bun() {
    ...
    echo ""
    echo "✓ Installed amaze via bun"
    echo "Run 'amaze' to get started!"
}
...
install_binary() {
    ...
    # Check if in PATH
    case ":$PATH:" in
        *":$INSTALL_DIR:"*) echo "Run 'amaze' to get started!" ;;
        *) echo "Add ${INSTALL_DIR} to your PATH, then run 'amaze'" ;;
    esac
}
