//! Native utilities exported via N-API for the Amaze toolchain.
//!
//! # Overview
...
//! # Example
//! ```ignore
//! use amaze_natives::text::visible_width;
//!
...
#[napi(js_name = "__amazeNativesV2_3_0")]
pub const fn amaze_natives_version_sentinel() {}
