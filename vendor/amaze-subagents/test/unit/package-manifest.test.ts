...
const sourceImportPattern = /from\s+["'](@steve-8000\/[^"']+)["']|import\s+["'](@steve-8000\/[^"']+)["']/g;
const oldPiScopePattern = /@mariozechner\/pi-/;
const piPackageJsonSubpathPattern = /@steve-8000\/pi-[^"']+\/package\.json/;
const cjsPiPackageResolutionPattern = /require(?:\.resolve)?\(\s*["']@steve-8000\/pi-/;
...
test("direct @steve-8000 runtime imports are declared for CI installs", () => {
