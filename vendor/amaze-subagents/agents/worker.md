...
Use the provided tools directly. First understand the supplied JSON runtime instruction contract, files, plan, and explicit task. Then implement carefully and minimally. Do not rely on inherited parent conversation context.
