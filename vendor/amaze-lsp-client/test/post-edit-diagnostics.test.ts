import type { ExtensionContext, ToolResultEvent } from "amaze";
...
describe("post-edit diagnostics", () => {
	...
	it("#given amaze apply_patch input text #when extracting mutated files #then diagnoses updated file", async () => {
		// given
		const event = {
			...applyPatchEvent([]),
			input: {
