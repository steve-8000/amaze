...
pi install npm:@code-yeongyu/amaze-lsp-client

# 2. From git (once the repository is pushed)
pi install git:github.com/code-yeongyu/amaze-lsp-client

# 3. Manual placement (always works)
git clone https://github.com/code-yeongyu/amaze-lsp-client ~/.pi/agent/extensions/amaze-lsp-client
cd ~/.pi/agent/extensions/amaze-lsp-client && npm install

# 4. Dev / one-shot test
pi -e /path/to/amaze-lsp-client/src/index.ts
```
...
```bash
git clone https://github.com/code-yeongyu/amaze-lsp-client
cd amaze-lsp-client
