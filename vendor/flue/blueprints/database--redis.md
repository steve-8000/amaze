...
Use a persistent standalone Redis server or managed single-shard endpoint with
`maxmemory-policy noeviction`. Redis Cluster and cache-only configurations are
