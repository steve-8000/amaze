...
The extension only contributes paths; Pi decides whether to load them. To suppress all skills in a session, uninstall the extension (`pi uninstall amaze-cua-integration`) or remove it from your Pi extension list. There is no granular skill filter in v0.1.
