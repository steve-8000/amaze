# amaze-cua-integration

[![ci](https://github.com/code-yeongyu/amaze-cua-integration/actions/workflows/ci.yml/badge.svg)](https://github.com/code-yeongyu/amaze-cua-integration/actions/workflows/ci.yml)
[![license: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

Cua ([trycua/cua](https://github.com/trycua/cua)) computer-use integration for the [amaze coding agent](https://github.com/badlogic/amaze/tree/main/packages/coding-agent).

`amaze-cua-integration` exposes Cua sandboxes (local Docker / QEMU / Lume / Tart and optional cloud) plus unsandboxed `Localhost` host control as Pi tools and skills. **Local mode is the default.** No Cua account is required to use it.
...
```bash
# 1. Install
pi install npm:amaze-cua-integration
pip install cua
...
|  amaze session                                  |
|  +---------------------------------------------+  |
|  |  amaze-cua-integration extension (TypeScript)   |  |
...
- [amaze](https://github.com/codeamaze) - the fork/runtime this extension targets
- [pi-anthropic-computer-use](https://github.com/steve-8000/amaze-anthropic-computer-use) - register Anthropic's native `computer` tool (compatible side-by-side)
