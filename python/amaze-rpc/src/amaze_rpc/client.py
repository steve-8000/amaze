...
class RpcClient:
    ...
    def start(self) -> RpcClient:
        ...
        self._stdout_thread = threading.Thread(target=self._read_stdout_loop, name="amaze-rpc-stdout", daemon=True)
        self._stderr_thread = threading.Thread(target=self._read_stderr_loop, name="amaze-rpc-stderr", daemon=True)
