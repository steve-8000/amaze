/**
 * Swarm agent execution via amaze-agent's subagent infrastructure.
 *
...
import { runSubprocess } from "@steve-z8k/pi-coding-agent";
...
/**
 * Execute a single swarm agent as an amaze-agent subagent.
 *
 * The agent receives:
