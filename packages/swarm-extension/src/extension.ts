 ...
 * then use /swarm in any amaze session.
 */

import * as fs from "node:fs/promises";
import * as path from "node:path";
import type { AuthStorage, ExtensionAPI, ExtensionCommandContext } from "@amaze/coding-agent";
import { formatDuration } from "@amaze/utils";
