 ...
 * `reasoning_content` even though amaze already sends it on the wire (the Kimi
...
import type { AssistantMessage, Context, FetchImpl, Model, ModelSpec } from "@steve-z8k/pi-ai/types";
