...
} from "@amaze/ai/model-thinking";
import type { Api, Model, Provider } from "@amaze/ai/types";
...
describe("model thinking metadata", () => {
	...
	it("encodes anthropic transport mode in metadata", () => {
		...
		// Opus 4.6 has no real xhigh level — ai aliases XHigh to Anthropic's "max".
...
describe("generated model policies", () => {
	...
	it("links spark variants and clears stale GPT-5.5 context promotion targets", () => {
		const models = [
			createModel({
