...
import { buildRequest } from "@amaze/ai/providers/google-gemini-cli";
import { convertTools } from "@amaze/ai/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@amaze/ai/types";
import {
	enforceStrictSchema,
