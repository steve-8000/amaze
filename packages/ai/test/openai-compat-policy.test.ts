...
import type { ResponseCreateParamsStreaming, ResponseInput } from "@amaze/pi-ai/providers/openai-responses-wire";
import {
...
import type { Model, ModelSpec, OpenAICompat } from "@amaze/pi-ai/types";
