...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@steve-z8k/pi-ai/types";
 ...
 * carries `tool_use_id`. As a workaround, Amaze must include `id` (aliased to
