...
```bash
npm install @amaze/pi-ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@amaze/pi-ai";
...
```typescript
import { z, Tool } from "@amaze/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@amaze/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@amaze/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@amaze/pi-ai";
...
```typescript
import { getModel, stream } from "@amaze/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@amaze/pi-ai";
...
```typescript
import { Model, stream } from "@amaze/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@amaze/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@amaze/pi-ai";
...
```typescript
import { getEnvApiKey } from "@amaze/pi-ai";
...
```typescript
import { loginGitHubCopilot } from "@amaze/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@amaze/pi-ai";
import * as fs from "node:fs";
