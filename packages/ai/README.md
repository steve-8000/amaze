...
```bash
npm install @steve-8000/amaze-ai
```

TypeBox exports are re-exported from `@steve-8000/amaze-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@steve-8000/amaze-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@steve-8000/amaze-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@steve-8000/amaze-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@steve-8000/amaze-ai';
...
```typescript
import { getImageModel, generateImages } from '@steve-8000/amaze-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@steve-8000/amaze-ai';
...
```typescript
import { getModel, stream } from '@steve-8000/amaze-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@steve-8000/amaze-ai';
...
```typescript
import { Model, stream } from '@steve-8000/amaze-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@steve-8000/amaze-ai';
...
```typescript
import { getModel, complete, Context } from '@steve-8000/amaze-ai';
...
```typescript
import { Context, getModel, complete } from '@steve-8000/amaze-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@steve-8000/amaze-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@steve-8000/amaze-ai';
...
```bash
npx @steve-8000/amaze-ai login              # interactive provider selection
npx @steve-8000/amaze-ai login anthropic    # login to specific provider
npx @steve-8000/amaze-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@steve-8000/amaze-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@steve-8000/amaze-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@steve-8000/amaze-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@steve-8000/amaze-ai`
