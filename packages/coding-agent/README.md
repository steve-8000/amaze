...
- [Monorepo README (GitHub)](https://github.com/can1357/amaze#readme)
...
The agent supports three mutually-exclusive memory backends, selected via the `memory.backend` setting (Settings → Memory tab, or `~/.amaze/config.yml`):
