...
import type { Effort } from "@amaze/ai";
import {
...
import type { EditorTheme, MarkdownTheme, SelectListTheme, SymbolTheme } from "@amaze/tui";
import { adjustHsv, getCustomThemesDir, isEnoent, logger } from "@amaze/utils";
...
const NERD_SYMBOLS: SymbolMap = {
	...
	"thinking.high": "\u{F111} deep",
	// pick: 🧠 core | alt:  core  core
	"thinking.xhigh": "\u{F06D} core",
	// Checkboxes
	// pick:  | alt:  
	"checkbox.checked": "\uf14a",
	// pick:  | alt: 
...
export function getSettingsListTheme(): import("@amaze/tui").SettingsListTheme {
	return {
