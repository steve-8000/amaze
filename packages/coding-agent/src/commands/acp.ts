/**
 * Run Amaze as an ACP (Agent Client Protocol) server over stdio.
 *
 ...
 */
import { Command } from "@steve-z8k/pi-utils/cli";
import { parseArgs } from "../cli/args";
import { runRootCommand } from "../main";
import { prepareAcpTerminalAuthArgs } from "../modes/acp/terminal-auth";

export default class Acp extends Command {
	static description = "Run Amaze as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
