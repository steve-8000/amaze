...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Reinstall amaze from source: pnpm install && pnpm build:pnpm`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.AMAZE_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json amazeConfig)
// =============================================================================
...
const amazeConfigName: string | undefined = pkg.amazeConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "amaze";
export const APP_NAME: string = amazeConfigName || "amaze";
export const APP_TITLE: string = amazeConfigName ? APP_NAME : "amaze";
export const CONFIG_DIR_NAME: string = pkg.amazeConfig?.configDir || ".amaze";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., AMAZE_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://amaze.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.AMAZE_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.amaze/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.amaze/agent/) */
