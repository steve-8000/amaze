...
export function createExtensionModuleImporter(): ExtensionModuleImporter {
...
export async function loadExtensionModule(extensionPath: string, importer: ExtensionModuleImporter) {
