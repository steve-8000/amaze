...
const GENERATED_GLOBAL_EXTENSION_BANNER =
	"// Generated by amaze. Delete this file to stop loading the default global extension.\n";
...
const VENDORED_BUILTIN_EXTENSION_PACKAGES: ReadonlyArray<{ builtinId: string; packageName: string }> = [
	{ builtinId: "anthropic-bash", packageName: "amaze-anthropic-bash" },
	{ builtinId: "anthropic-web-search", packageName: "amaze-anthropic-web-search" },
	{ builtinId: "gpt-apply-patch", packageName: "amaze-apply-patch" },
	{ builtinId: "bash-timeout", packageName: "amaze-bash-timeout" },
	{ builtinId: "openai-web-search", packageName: "amaze-openai-web-search" },
	{ builtinId: "todowrite", packageName: "amaze-todotools" },
];
...
export class DefaultResourceLoader implements ResourceLoader {
	...
	private async loadFinalExtensionSet(
		...
		// Carry over ALL factory-loaded extensions from the bootstrap pass: both inline
		// (API-registered) and builtin. Previously only `<inline:` was kept, which dropped
		// every builtin extension whenever a trust-requiring project resource (e.g.
		// `.amaze/skills`) forced the pre-trust bootstrap path.
