...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@steve-z8k/pi-ai";
...
// Per-provider image-count budgets live in @steve-z8k/snapcompact
