...
export const MAX_OUTPUT_BYTES = parseNumber($env.AMAZE_TASK_MAX_OUTPUT_BYTES, 500_000);

/** Maximum output lines per agent */
export const MAX_OUTPUT_LINES = parseNumber($env.AMAZE_TASK_MAX_OUTPUT_LINES, 5000);
