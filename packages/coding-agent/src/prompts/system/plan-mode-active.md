...
You MUST use clear markdown headers; include these approval-gate sections:
- `# <title>`
- `## Objective`
- `## Scope`
- `## Execution Plan`
...
### Phase 4: Update Plan
You MUST update `{{planFilePath}}` (`{{editToolName}}` for changes, `{{writeToolName}}` only if creating from scratch) with these approval-gate sections:
- `# <title>`
- `## Objective`
- `## Scope`
- `## Execution Plan`
