...
import { registerOAuthProvider, unregisterOAuthProviders } from "@amaze/ai/utils/oauth";
import type { OAuthCredentials, OAuthLoginCallbacks } from "@amaze/ai/utils/oauth/types";
import { isRecord, logger } from "@amaze/utils";
...
export function hasUsableAuth(apiKey: unknown): apiKey is string {
	if (apiKey === kNoAuth) return true;
...
export const MODEL_ROLES: Record<ModelRole, ModelRoleInfo> = {
	...
	Planner: { tag: "PLANNER", name: "Planner", color: "muted" },
