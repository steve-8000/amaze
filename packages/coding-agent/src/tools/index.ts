...
export const BUILTIN_TOOLS: Record<BuiltinToolName, ToolFactory> = {
	...
	index_repository: s => new IndexRepositoryTool(s),
	...
	get_graph_schema: s => new GetGraphSchemaTool(s),
	get_architecture: s => new GetArchitectureTool(s),
	query_graph: s => new QueryGraphTool(s),
	delete_project: s => new DeleteProjectTool(s),
	index_status: s => new IndexStatusTool(s),
	detect_changes: s => new DetectChangesTool(s),
	manage_adr: s => new ManageAdrTool(s),
	ingest_traces: s => new IngestTracesTool(s),
