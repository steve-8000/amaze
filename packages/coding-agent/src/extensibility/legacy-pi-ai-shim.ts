 ...
 * `@steve-z8k/pi-ai` (or one of its aliased scopes like `@earendil-works/pi-ai`
 ...
 * bare package root. Subpath imports (`@steve-z8k/pi-ai/oauth`, etc.)
