 ...
 */
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "@amaze/agent-core";
import type { CompactionResult } from "@amaze/agent-core/compaction";
import type {
	Api,
...
import type { OAuthCredentials, OAuthLoginCallbacks } from "@amaze/ai/utils/oauth/types";
import type * as piCodingAgent from "@amaze/coding-agent";
import type { AutocompleteItem, Component, EditorTheme, KeyId, TUI } from "@amaze/tui";
...
export interface ExtensionAPI {
	...
	logger: typeof import("@amaze/utils").logger;
