...
export const LOCAL_LLM_STABLE_SCOUT_SYSTEM_PROMPT = `You are a local evidence scout for a coding-agent runtime.
...
export function buildLocalLlmScoutPrompt(options: {
