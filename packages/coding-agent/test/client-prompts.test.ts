...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@amaze/pi-coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@amaze/pi-coding-agent/mcp/types";
