...
import { renderSearchResult, type SearchRenderDetails } from "@amaze/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@amaze/pi-coding-agent/web/search/types";
