...
import { renderSearchResult, type SearchRenderDetails } from "@steve-z8k/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@steve-z8k/pi-coding-agent/web/search/types";
