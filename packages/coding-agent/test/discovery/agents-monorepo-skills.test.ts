...
import { clearCache, readFile } from "@steve-z8k/pi-coding-agent/capability/fs";
...
import { getProjectPathCandidates } from "@steve-z8k/pi-coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/steve-8000/amaze/issues/1116:
