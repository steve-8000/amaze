...
import { loadCapability, setDisabledProviders } from "@steve-z8k/pi-coding-agent/capability";
import type { ContextFile } from "@steve-z8k/pi-coding-agent/capability/context-file";
import { clearCache } from "@steve-z8k/pi-coding-agent/capability/fs";
import type { Instruction } from "@steve-z8k/pi-coding-agent/capability/instruction";
import type { Prompt } from "@steve-z8k/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@steve-z8k/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@steve-z8k/pi-coding-agent/internal-urls/rule-protocol";
import "@steve-z8k/pi-coding-agent/capability/context-file";
import "@steve-z8k/pi-coding-agent/capability/instruction";
import "@steve-z8k/pi-coding-agent/capability/prompt";
import "@steve-z8k/pi-coding-agent/capability/rule";
import "@steve-z8k/pi-coding-agent/discovery/github";
