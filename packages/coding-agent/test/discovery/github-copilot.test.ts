...
import { loadCapability, setDisabledProviders } from "@amaze/pi-coding-agent/capability";
import type { ContextFile } from "@amaze/pi-coding-agent/capability/context-file";
import { clearCache } from "@amaze/pi-coding-agent/capability/fs";
import type { Instruction } from "@amaze/pi-coding-agent/capability/instruction";
import type { Prompt } from "@amaze/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@amaze/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@amaze/pi-coding-agent/internal-urls/rule-protocol";
import "@amaze/pi-coding-agent/capability/context-file";
import "@amaze/pi-coding-agent/capability/instruction";
import "@amaze/pi-coding-agent/capability/prompt";
import "@amaze/pi-coding-agent/capability/rule";
import "@amaze/pi-coding-agent/discovery/github";
