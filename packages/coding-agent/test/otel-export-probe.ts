...
} from "@steve-z8k/pi-coding-agent/telemetry-export";
...
process.env.OTEL_SERVICE_NAME = "amaze-agent-export-probe";
...
const span = trace.getTracer("@steve-z8k/pi-agent-core").startSpan("agent.llm_call");
span.setAttribute("gen_ai.system", "probe");
span.setAttribute("gen_ai.request.model", "claude-opus-4-7");
span.end();
