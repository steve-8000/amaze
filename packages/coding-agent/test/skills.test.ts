...
import { type Skill as CapabilitySkill, skillCapability } from "@amaze/coding-agent/capability/skill";
import { getCapability } from "@amaze/coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@amaze/coding-agent/extensibility/skills";
