...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@steve-z8k/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@steve-z8k/pi-coding-agent/session/session-entries";
