...
import { clearClaudePluginRootsCache } from "@steve-z8k/pi-coding-agent/discovery/helpers";
import "@steve-z8k/pi-coding-agent/discovery/claude-plugins";
import type { MCPServer } from "@steve-z8k/pi-coding-agent/capability/mcp";
