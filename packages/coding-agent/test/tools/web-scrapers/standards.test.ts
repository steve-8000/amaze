...
import { handleCheatSh } from "@amaze/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@amaze/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@amaze/pi-coding-agent/web/scrapers/tldr";
