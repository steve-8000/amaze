...
import { handleChocolatey } from "@amaze/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@amaze/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@amaze/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@amaze/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@amaze/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@amaze/pi-coding-agent/web/scrapers/terraform";
