...
import { handleChocolatey } from "@steve-z8k/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@steve-z8k/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@steve-z8k/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@steve-z8k/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@steve-z8k/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@steve-z8k/pi-coding-agent/web/scrapers/terraform";
