...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@amaze/pi-coding-agent/capability/rule";
import { bucketRules } from "@amaze/pi-coding-agent/capability/rule-buckets";
