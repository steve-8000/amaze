...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@steve-z8k/pi-coding-agent/capability/rule";
import { bucketRules } from "@steve-z8k/pi-coding-agent/capability/rule-buckets";
