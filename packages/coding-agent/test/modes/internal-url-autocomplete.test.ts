...
import { resetActiveRulesForTests, setActiveRules } from "@steve-z8k/pi-coding-agent/capability/rule";
...
import { InternalUrlRouter } from "@steve-z8k/pi-coding-agent/internal-urls/router";
import {
	applyInternalUrlCompletion,
	extractInternalUrlContext,
	getInternalUrlSuggestions,
	isInternalUrlPrefix,
} from "@steve-z8k/pi-coding-agent/modes/internal-url-autocomplete";
import { PromptActionAutocompleteProvider } from "@steve-z8k/pi-coding-agent/modes/prompt-action-autocomplete";
