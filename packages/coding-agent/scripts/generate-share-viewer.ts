#!/usr/bin/env bun
/**
 * Build the standalone share-viewer page the amaze relay serves at `GET /s/<id>`.
 *
...
// Pin the amaze brand palette (collab-web pink/purple identity) — the viewer is
// a public artifact matching the live my.amaze client, not a per-user export
...
const html = getTemplate()
	...
	.replace("<title>Session Export</title>", () => "<title>amaze session</title>")
