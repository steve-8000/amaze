 ...
 * (logo + keybinding hints) with a custom component showing the amaze mascot.
 */

import type { ExtensionAPI, Theme } from "amaze";
import { VERSION } from "amaze";

// --- PI MASCOT ---
// Based on amaze_mascot.ts - the amaze agent character
