...
```typescript
import { grep, find, encodeSixel } from "@steve-z8k/pi-natives";
...
`@steve-z8k/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @steve-z8k/pi-natives-<platform>-<arch>
