 ...
 *
 * Bump policy: `__amazeNativesV{major}_{minor}_{patch}` — non-alphanumerics in
 * the version string are mapped to `_` to keep it a valid JS identifier.
 * MUST stay in sync with `VERSION_SENTINEL_EXPORT` in
 * `packages/natives/native/index.js` (which derives the name from
 * `package.json#version`).
 */
export declare function __amazeNativesV1_0_0(): void
 ...
 * `amaze_shell::fixup`. Synchronous and cheap (one parse pass over the input).
 */
 ...
 *
 * Uses [`amaze_iso::IsolationBackend::diff`]'s default implementation —
 ...
 * a hint — see [`amaze_iso::resolve`] for the exact priority rules.
 */
