...
const SLEEP_BATCH_SIZE = envInt("ROCKY_MEMORY_SLEEP_BATCH", 5000);
const TIER2_DAYS = envInt("ROCKY_MEMORY_TIER2_DAYS", 30);
const TIER3_DAYS = envInt("ROCKY_MEMORY_TIER3_DAYS", 180);
const DEGRADE_BATCH_SIZE = envInt("ROCKY_MEMORY_DEGRADE_BATCH", 100);
const TIER3_MAX_CHARS = envInt("ROCKY_MEMORY_TIER3_MAX_CHARS", 300);
