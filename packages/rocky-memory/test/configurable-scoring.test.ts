...
const ORIGINAL_ENV = {
	ROCKY_MEMORY_VEC_WEIGHT: process.env.ROCKY_MEMORY_VEC_WEIGHT,
	ROCKY_MEMORY_FTS_WEIGHT: process.env.ROCKY_MEMORY_FTS_WEIGHT,
	ROCKY_MEMORY_IMPORTANCE_WEIGHT: process.env.ROCKY_MEMORY_IMPORTANCE_WEIGHT,
};
...
describe("configurable recall scoring", () => {
	it("normalizes defaults, explicit weights, zeros, and negative inputs", () => {
		delete process.env.ROCKY_MEMORY_VEC_WEIGHT;
		delete process.env.ROCKY_MEMORY_FTS_WEIGHT;
		delete process.env.ROCKY_MEMORY_IMPORTANCE_WEIGHT;
	...
	it("reads environment weights when no explicit config is supplied", () => {
		process.env.ROCKY_MEMORY_VEC_WEIGHT = "0.7";
		process.env.ROCKY_MEMORY_FTS_WEIGHT = "0.2";
		process.env.ROCKY_MEMORY_IMPORTANCE_WEIGHT = "0.1";
	...
	it("lets environment weights affect BeamMemory defaults", async () => {
		process.env.ROCKY_MEMORY_VEC_WEIGHT = "0.1";
		process.env.ROCKY_MEMORY_FTS_WEIGHT = "0.1";
		process.env.ROCKY_MEMORY_IMPORTANCE_WEIGHT = "0.8";
		const beam = makeBeam();
