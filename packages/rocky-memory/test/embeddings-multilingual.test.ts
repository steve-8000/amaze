...
describe("multilingual embedding metadata", () => {
	it("detects English, Chinese, multilingual, Jina, and OpenAI dimensions", () => {
		withEnvValue("ROCKY_MEMORY_EMBEDDING_DIM", undefined, () => {
	...
	it("allows ROCKY_MEMORY_EMBEDDING_DIM to override model dimensions", () => {
		withEnvValue("ROCKY_MEMORY_EMBEDDING_DIM", "768", () => {
		...
		withEnvValues(
			{
				...
				ROCKY_MEMORY_EMBEDDINGS_VIA_API: undefined,
