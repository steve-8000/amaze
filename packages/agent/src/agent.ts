...
export interface AgentOptions {
	...
	/**
	 * Cache retention preference forwarded to providers that support prompt
	 * caching. `undefined` defers to {@link resolveCacheRetention}'s default.
	 */
...
export class Agent {
	...
	/**
	 * Cache retention preference forwarded to providers for prompt caching.
	 * `undefined` means the provider/global default applies.
	 */
