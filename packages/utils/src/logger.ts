/**
 * Centralized logger for amaze.
 *
 * Default: rotating `~/.amaze/logs/amaze.<DATE>.log`, no console output (writing
 ...
 *
 * Each entry includes `process.pid` so concurrent amaze instances stay
 * traceable.
 */
